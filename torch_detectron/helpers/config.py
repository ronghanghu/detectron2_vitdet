...
_C.MODEL.INTERNAL_REPRESENTATION_SIZE = 256 * 4
...
link_nodes(_C, 'MODEL.BACKBONE.REPRESENTATION_SIZE', 'MODEL.INTERNAL_REPRESENTATION_SIZE')
link_nodes(_C, 'MODEL.REGION_PROPOSAL.NUM_INPUT_FEATURES', 'MODEL.INTERNAL_REPRESENTATION_SIZE')
link_nodes(_C, 'MODEL.HEADS.REPRESENTATION_SIZE', 'MODEL.INTERNAL_REPRESENTATION_SIZE')
