...
from torch_detectron.utils.comm import is_main_process
...
def cache_url(url, model_dir=None, progress=True):
    ...
    Example:
        >>> cached_file = torch_detectron.utils.model_zoo.cache_url('https://s3.amazonaws.com/pytorch/models/resnet18-5c106cde.pth')
    """
