...
from maskrcnn_benchmark.layers import cat, nms as _box_nms

from .bounding_box import BoxList


def boxlist_nms(boxlist, nms_thresh, topk=-1, score_field="score"):
    """
    ...
    Arguments:
        boxlist(BoxList)
        nms_thresh (float)
        topk (int): if > 0, then only the top topk are kept
