...
class ROIHeads(torch.nn.Module):
    def __init__(self, cfg):
        ...
        self.feature_strides          = dict(zip(cfg.MODEL.BACKBONE.FEATURE_NAMES,
                                                 cfg.MODEL.BACKBONE.FEATURE_STRIDES))
        self.feature_channels         = dict(zip(cfg.MODEL.BACKBONE.FEATURE_NAMES,
                                                 cfg.MODEL.BACKBONE.FEATURE_CHANNELS))
        # fmt: on
