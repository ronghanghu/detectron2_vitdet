...
# # from beit init (Beit-Base-300ep, 83.1% )
# train.init_checkpoint = "/checkpoint/kaiminghe/logs/deit/210724-095830-OrgIN1K-4n-BeiT-Base-ep300-lr1.5e-3-authors/checkpoint-299.pth"  
# from beit init (Beit-Base-800ep, X% )
train.init_checkpoint = "/checkpoint/kaiminghe/logs/deit/210921-161747-OrgIN1K-4n-BeiT-Base-ep800-lr1.5e-3-authors-resume1/checkpoint-799.pth" 
...
# model pos embed pre-train from checkpointing
model.backbone.bottom_up.net.pos_init_checkpoint = train.init_checkpoint
